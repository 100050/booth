...
# 모델 위치
model_filename ='D:/코딩 김인환/Python/부스/model/keras_model.h5'
...
def runGame():
    ...
    while keyC == 0:
        ...
        if jump is False and (prediction[0,0] > 0.99): # 주먹일 때 점프 // 스페이스바 누르면 작동되는거 userInput[pygame.K_SPACE]
        ...
        if prediction[0,2] > 0.99: # 따봉일 때 시작// 키보드 1을 누르면 게임 시작 userInput[pygame.K_1]
            start = True
        ...
        #충돌
        crash0(beecraft1 or beecraft2, ms1)
        crash1(beecraft1 or beecraft2, ms2)
        crash2(beecraft1 or beecraft2, bear1 or bear2 or bear3)
        crash3(beecraft1 or beecraft2, dionaea1 or dionaea2 or dionaea3 or dionaea4 or dionaea5)
...
def initGame():
    ...
    # beecraft = [pygame.image.load(route+'honeybee/honeybee1.png').convert_alpha(), pygame.image.load(route+'honeybee/honeybee2.png').convert_alpha()]
    # beecraft[0] = pygame.transform.scale(beecraft1, (100, 100))
    # beecraft[1] = pygame.transform.scale(beecraft2, (100, 100))
